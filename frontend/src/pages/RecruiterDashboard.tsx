...
type TabType = 'overview' | 'jobs' | 'candidates' | 'analytics' | 'settings';
...
const RecruiterDashboard: React.FC = () => {
    ...
    const [applicationVolume] = useState<number[]>([45, 32, 28, 38, 52, 61, 48]);
    ...
    const handleCreateJob = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        e.preventDefault();
        try {
            const config = {
